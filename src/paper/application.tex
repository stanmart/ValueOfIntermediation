...
\pgfplotstableread[col sep=comma]{out/figures/equilibrium_profit_onesided.csv}\equilibriumTest
\pgfplotstableread[col sep=comma]{out/figures/equilibrium_welfare_onesided.csv}\equilibriumFullSurplus
