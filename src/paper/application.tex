...
% \pgfplotstableread[col sep=comma]{out/figures/equilibrium_welfare_twosided_scale-1_lambda-1.csv}\equilibriumFullSurplusTwoSided
% \pgfplotstableread[col sep=comma]{out/figures/equilibrium_welfare_twosided_scale-1_lambda-0.5.csv}\equilibriumProfitOneSidedLowLambda
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=black,mark=none,thick,dashed] table[x=N_P,y=A]{\equilibriumFullSurplusOneSided};
