...
\newcommand*{\latestversion}{\normalsize{Latest version: \href{https://stanmart.github.io/ValueOfIntermediation/theory.pdf}{stanmart.github.io/ValueOfIntermediation/application.pdf}}}
...
The framework quite general, and does not depend on a specific demand structure, investment cost assumptions, and there is even some flexibility to the assumptions about bargaining outcomes.
...
In particular, I provide some sharper results under the assumption of logit-like demand and a specific form of the bargaiing rule.
...
The closest paper to this second, more applied part of this one is \textcite{anderson2021hybrid}.
The main difference between the two boils down to how the entry fee is decided.
In the former, of the platform setting a percentage entry fee and being able to commit to it, I assume that (1) platforms charge a lump-sum entry fee and that (2) this entry fee is the result of a negotiation process\footnote{
