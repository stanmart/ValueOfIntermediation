...
The timing of the two models is illustrated in \cref{fig:timing}.
...
\begin{figure}
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \begin{tikzpicture}[node distance=2cm, auto]
            ...
            \node[align=center] (sales) [below of=entry_decision] {($\mathbf{T_3}$) Platform and fringe sell products \\ $[\pi_{Fi}^v, \pi_P^v]$};
            \node[align=center] (final) [below of=sales] {($\mathbf{T_4}$) Final profits are realized \\ $[\pi_{Fi}^t, \pi_P^t]$};
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \begin{tikzpicture}[node distance=2cm, auto]
            ...
            \node[align=center] (sales) [below of=entry_fee] {($\mathbf{T_3}$) Platform and fringe sell products \\ $[\pi_{Fi}^v, \pi_P^v]$};
            \node[align=center] (final) [below of=sales] {($\mathbf{T_4}$) Final profits are realized \\ $[\pi_{Fi}^t, \pi_P^t]$};
