...
In the last couple of decades, a considerable amount of research has been devoted to the study of platforms.
This paper aims to contribute to this literature by examining an important, but somewhat underexplored aspect of platforms: the bargaining power disparity between them and the other market participants, and how this disparity is affected by the platforms' hybrid operation.
In particular, this paper proposes an analytically tractable framework which captures many important aspects of bargaining between one large and a continuum of small players, and applies it to the setting of a hybrid platform facing a continuum of potential entrants.
The results show that when a platform operating in hybrid mode can increase its profits at the cost of decreased seller entry consumer welfare in comparison to the case when the platform is a pure intermediary.
Before an overview of the relevant literature is given, it is useful to briefly discuss the most prominent features of platforms, as that will be useful to understand the relation of this paper to the existing body of research.
...
First, platforms are often characterized by multi-sidedness.\footnote{
    The most prominent examples are large internet companies, such as Google connecting advertisers and consumers, Amazon connecting sellers and consumers, or Uber connecting drivers and passengers.
}
Second, a frequent feature of platforms is the presence of network effects.\footnote{
...
A third important aspect of platforms is the disparity between the various market participants.
...
Most of the earlier literature on platform economics focuses on the multi-sidedeness of platforms and the related network effects.
...
More recently, hybrid platforms also received increasing attention in the literature.
...
On the other hand, more recent papers, such as \textcite{hagiu2022should}, \textcite{anderson2021hybrid} and \textcite{gutierrez2021welfare} have started to address the issue of hybrid platforms, and how platforms having their own products affect competition between the platform and the entrants, and ultimately consumer welfare and producer surplus.
...
In contrast to the majority of those, I utilize an oceanic game (a continuum of small players instead of a finite number), and demonstrate that this can considerably simplify the analysis in certain cases.
