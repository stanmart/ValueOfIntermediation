...
Let us now turn to platform entry fees and fringe entry decisions in the benchmark model.
...
\begin{corollary}
    \begin{align*}
        N_F = 0 \implies \frac{\partial CS}{\partial N_P} = \frac{V_P}{1 + N_P V_P} > 0.
    \end{align*}
\end{corollary}
