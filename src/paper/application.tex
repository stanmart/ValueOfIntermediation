...
\begin{corollary}
    ...
    Let \cref{ass:identical_fringe,ass:monotone_profits,ass:profit_sharing,ass:free_entrya,ass:single_crossing} hold.
    Furthermore, assume that $f, w$ are twice continuously differentiable.
...
\begin{proposition}
    ...
    Let \cref{ass:identical_fringe,ass:monotone_profits,ass:profit_sharing,ass:free_entrya,ass:single_crossing,ass:additive_profit} hold.
    Then
    \begin{align*}
