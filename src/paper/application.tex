...
I show that hybrid operation can indeed have negative welfare consequences for consumers in the presence of bargaining.
This result is particularly striking in this otherwise distortion-free\footnote{
    The platform's hybrid operation does not affect consumer welfare in the benchmark model without bargaining.
} setting. 
