...
\textcite{stancsics2023value} examines this solution concept for a similar game, but in a more more abstract setting.
...
\begin{proposition}
    ...
    Further assume that $f$ is continuously differentiable with respect to $N_P$ and also twice differentiable.
    Let $N_F \geq 0$.
...
Finally, let us examine how the platform's product variety impacts its total profits, also taking into account its effect on the number of fringe entrants.
...
Finally, this section focuses on the main model, with two-sided bargaining, and the Shapley value as the solution concept.
