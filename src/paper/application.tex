...
\end{align*}
Then, equilibrium per-product demand and variable profit can be expressed as $V_T/ A$ and $\mu V_T/ A$, respectively.
...
\begin{align*}
    N_F = \frac{\mu}{F_F + I_F} - I_F N_P \frac{V_P}{V_F} - \frac{1}{V_F}.
\end{align*}
