    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \begin{tikzpicture}[scale=0.8]
            ...
            \begin{axis}[xmin=0, xmax=1, ymin=0, ymax=1, samples at={0, 0.02, ..., 0.98, 1},
                ...
                \node[anchor= east] at (axis cs: .9, .9^2) {$N_C f(N_P, sN_F)$};
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}[scale=0.8]
            \begin{axis}[xmin=0, xmax=1, ymin=0, ymax=1, samples at={0, 0.02, ..., 0.98, 1},
                ...
                \node[anchor=north west] at (axis cs: .6, .6^0.5) {$N_C \tilde{f}(N_P, sN_F)$};
                \path[name path=bottom] (axis cs:0,0) -- (axis cs:1,0);
                \path[name path=top] (axis cs:0,1) -- (axis cs:1,1);
...
Let us now add more structure to the model, and microfound the profit function $\Pi$.
