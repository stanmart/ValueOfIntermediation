...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
                ...
                ymin=0, ymax=1, % adjust these values as needed
                % grid=major,
                % grid style={dashed,gray!30},
                width=6cm, % adjust the width of the plot
                height=6cm, % adjust the height of the plot
                axis lines=left,
                xtick=\empty, ytick=\empty
            ]
            \addplot[color=blue,mark=none,very thick] table[x=N_P,y=N_F]{\equilibrium};
            \addplot[color=black,mark=none,dashed] table[x=N_P,y=N_F_cf]{\equilibrium};
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Equilibrium aggregate as a function of the number of platform products.}
