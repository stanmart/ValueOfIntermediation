    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    xlabel={$N_P$},
                    xmin=0, xmax=4.5, % adjust these values as needed
                    ymin=0, ymax=5.5, % adjust these values as needed
                    width=\linewidth, % adjust the width of the plot
                    axis lines=left,
                    xtick={0, 4.5},
                    legend pos=south east
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                    xlabel={$N_P$},
                    xmin=0, xmax=4.5, % adjust these values as needed
                    ymin=0, ymax=1.1, % adjust these values as needed
                    width=\linewidth, % adjust the width of the plot
                    axis lines=left,
                    xtick={0, 4.5},
                    legend pos=south east,
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[color=myblue,mark=none,thick] table[x=N_P,y=K_F_opt]{\equilibrium};
                \addplot[color=myred,mark=none,thick] table[x=N_P,y=K_F_implied]{\equilibrium};
                \addplot[color=mygreen,mark=none,thick] table[x=N_P,y=K_F_implied]{\equilibriumProfitOneSidedLowLambda};
...
TODO: discuss the assumptioin of pricing products separately
