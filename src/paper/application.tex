...
\begin{proposition}
    ...
    Under the conditions in assumption \ref{ass:single_crossing}, the equilibrium is unique.
\end{proposition}
...
\begin{proposition}
    ...
    \begin{align*}
        \pi^t_P &= \varphi_P = \int_0^1 f(N_P, sN_F) \ds \\
...
\textcolor{red}{
    Note: I have not managed to prove lemma \ref{lem:profit_assumptions} yet, but I'm pretty sure it's true.
...
\begin{lemma}
    ...
    $f(n_P, n_F)$ satisfies assumption \ref{ass:single_crossing}.
    Furthermore,
    \begin{align*}
