...
For one, I focus on the asymptotic approach, and withing that, a specific way of approximating the infinite game of interest.
...
The present paper contributes to this literature by generalizing some of its results, and an examinating some general properties of the various values in the context of such games.
In particular, in addition to the aformentioned papers, the proposed model includes two new features: (1) results about the distribution of the value between the various types of fringe players, and (2) using random order values instead of the less general Shapley value or weighted value.
