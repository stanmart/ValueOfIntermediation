...
\begin{align*}
    f(n_1, n_2) = n_1 \alpha_1 n_2^{\gamma_1} + n_2 \alpha_2 n_1^{\gamma_2} - F_1 n_1 - F_2 n_2.
\end{align*}
...
\begin{proposition}
    ...
    \begin{align*}
        \pi_P(n_1, n_2) &= \int_0^1 \lambda_P t^{\lambda_P - 1} f(t_1^{\lambda_1} n_1, t_1^{\lambda_2} n_2) \dt \\
        u_i(n_1, n_2) &= \int_0^1 t^{\lambda_P} \partial_i f(t_1^{\lambda_1} n_1, t_1^{\lambda_2} n_2) \dt
    \end{align*}
\end{proposition}
