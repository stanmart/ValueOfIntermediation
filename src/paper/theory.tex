...
\begin{proposition}
    ...
    Let $f$ be continuous on [0, 1]. Furthermore, let us denote the random variable $\frac{|\mathcal{P}_P|}{n}$ as $X_n$. Assume that $X_n \xrightarrow[]{\mathrm{d}} X$ with cdf $G_X(t)$ and (if exists) pdf $g(t)$.
    Then
    \begin{align*}
...
\begin{proof}[Proof of Proposition \ref{prop:one_sided_general}]
    ...
    \end{align*}
    As $f$ is continuous and bounded, and $X_n \xrightarrow[]{\mathrm{d}} X$, by Portmanteau's lemma, $\E[f(X_n)] \to \E[f(X)]$.
    Putting it together,
    \begin{align*}
...
\begin{proposition}
    ...
    \end{align*}
    Assume that $X_n \xrightarrow[]{\mathrm{d}} X$ with cdf $G_X(t_1, \dots, t_L)$ and (if exists) pdf $g(t_1, \dots, t_L)$.
    Then
    \begin{align*}
...
\begin{proof}[Proof of Proposition \ref{prop:many_sided_general}]
    ...
    \begin{align*}
        ...
        &= \E[f(X_n)].
    \end{align*}
    Furthermore, as $f$ is continuous (and therefore bounded on $[0, 1]^L$), and $X_n \xrightarrow[]{\mathrm{d}} X$, by Portmanteau's lemma, $\E[f(X_n)] \to \E[f(X)]$.
    Putting it together,
    \begin{align*}
