...
\begin{abstract}
    ...
    On one hand, this paper serves as a taxonomization of various results found in some applied papers.
...
The case of one indispensable player and a large number of small ones is particularly important, for example, in the context of vertical markets or platforms.
