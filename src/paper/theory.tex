...
This can be considered as the main theorem of the paper, as most of the propositions in the previous sections are special cases of it.
...
\begin{align*}
    ...
    p_i^u &= \underbracket{F_i}_{(1)} - \underbracket{\alpha_j n_j n_i}_{(2)} + \underbracket{n_i \kappa'_i(n_i)}_{(3)} \\
    p_i^b &= \underbracket{\frac{1}{2} F_i}_{(1)} - \underbracket{\frac{1}{3} \alpha_j n_j n_i}_{(2)} + \underbracket{\frac{2}{3} \alpha_i n_j - \int_0^{n_1} \left[ 1 - \frac{s}{n_i} \right] \kappa_i(s) \ds}_{(4)},
\end{align*}
...
Now let us consider the cases of non-linear network effects.
...
\begin{align*}
    ...
    p_i^b &= \underbracket{\frac{1}{2} F_i}_{(1)} - \underbracket{\frac{\gamma_j}{2 + \gamma_j} \alpha_j n_j n_i^{\gamma_j - 1}}_{(2)} + \underbracket{\frac{1 + \gamma_i}{2 + \gamma_i} \alpha_i n_j^{\gamma_i} - \int_0^{n_1} \left[ 1 - \frac{s}{n_i} \right] \kappa_i(s) \ds}_{(4)}.
\end{align*}
...
\begin{theorem}
    ...
    \begin{align*}
        ...
        &+ \underbracket{\frac{\lambda_P + \lambda_j\gamma_i}{\lambda_P + \lambda_i + \lambda_j\gamma_i} \alpha_i n_j^{\gamma_i} - \int_0^{n_1} \left[ 1 - \lambda_i \left( \frac{s}{n_i} \right)^{\lambda_P + \lambda_i - 1} \right] \kappa_i(s) \ds}_{(4)}.
    \end{align*}
\end{theorem}
