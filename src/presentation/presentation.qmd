...
::: {.notes}
 ...
 - Think of it as a convenient gain sharing rule with some (cooperative and non-cooperative) microfoundations
:::
...
::: {.notes}
 - Not only platforms. Also describes
   - upstream-downstream setups
   - generally any setting with an important large palyers and many identical small ones
:::
...
::: {.notes}
 ...
 - Most elemnts borrowed from [@anderson2021hybrid]
:::
...
::: {.column width="45%"}
 ...
 3. Firms and platforms set product prices
 4. Consumers choose products

**Idea:** 2. stage bargaining is over *final allocations*
:::
...
$$
v(N_f) = \frac{N_P B + N_F B}{N_P B + N_F B + 1} \quad \text{ where } B = e^\frac{v - c - \mu}{\mu}
$$
...
My contributions
 ...
 - The continuous case is vary tractable in this speciific setting
...
::: {.notes}
 ...
 - However, some situations just don't fit the model
