...
:::
::: {.fragment}
 - Can be extended with weighting (innate bargaining power)
:::
...
::: {.incremental}
 ...
 - In order to guarantee uniqueness, let us assume
   ...
   \scriptsize
   \begin{gather*}
       f'_{n_F} (N_P, N_F) < \int_0^1 s f'_{n_F} (N_P, s N_F) \mathrm{d}s \\
       \text{or} \\
       f''_{n_F} (N_P, N_F) < \int_0^1 s^2 f''_{n_F} (N_P, s N_F) \mathrm{d}s.
   \end{gather*}
   $$
