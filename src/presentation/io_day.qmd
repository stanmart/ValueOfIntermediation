...
::: {.fragment fragment-index=4}
 - It depends™ for the fringe
   - It's profits increase if and only if platform and fringe products are complements:
...
::: {.fragment}
 - Longer term
   - Endogeneize consumer entry (possibly with consumers also engaging in the negotiation)
