...
def create_plot(out_path: str, mu: float = 1, V_P: float = 1, V_F: float = 1, I_F: float = 0.2,
    ...
    fig, ax = plot_equilibrium_nf(N_P_list=N_P, mu=mu, V_P=V_P, V_F=V_F, I_F=I_F, N_F_range=N_F_range, num_obs=num_obs)
